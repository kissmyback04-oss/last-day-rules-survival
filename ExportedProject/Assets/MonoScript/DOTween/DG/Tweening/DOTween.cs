...
namespace DG.Tweening
{
	public class DOTween
	{
		...
		private sealed class _003C_003Ec__DisplayClass53_0
		{
			...
			internal float _003CTo_003Eb__0()
			{
				return v;
			}

			internal void _003CTo_003Eb__1(float x)
			{
				v = x;
				setter(v);
			}
		...
		public static Tweener To(DOSetter<float> setter, float startValue, float endValue, float duration)
		{
			...
			_003C_003Ec__DisplayClass53_.setter = setter;
			_003C_003Ec__DisplayClass53_.v = startValue;
			return To(_003C_003Ec__DisplayClass53_._003CTo_003Eb__0, _003C_003Ec__DisplayClass53_._003CTo_003Eb__1, endValue, duration).NoFrom();
		}
