...
namespace DigitalOpus.MB.Core
{
	...
	public class MB3_MeshCombinerSingle : MB3_MeshCombiner
	{
		...
		{
			_003C_addToCombined_003Ec__AnonStorey0 _003C_addToCombined_003Ec__AnonStorey = new _003C_addToCombined_003Ec__AnonStorey0();
			...
			_003C_addToCombined_003Ec__AnonStorey1 _003C_addToCombined_003Ec__AnonStorey2 = new _003C_addToCombined_003Ec__AnonStorey1();
			...
			{
				if (!instance2Combined_MapContainsKey(_003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i].GetInstanceID()) || Array.FindIndex(array, _003C_addToCombined_003Ec__AnonStorey2._003C_003Em__0) != -1)
				{
					MB_DynamicGameObject mB_DynamicGameObject = new MB_DynamicGameObject();
					GameObject gameObject = _003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i];
					...
					for (int num7 = 0; num7 < gOMaterials.Length; num7++)
					{
						...
						if (obj == null)
						{
							Debug.LogError(string.Concat("Source object ", gameObject.name, " used a material ", gOMaterials[num7], " that was not in the baked materials."));
							return false;
						}
						int idxInResultMats = (int)obj;
						if (!material2AtlasRectangleMapper.TryMapMaterialToUVRect(gOMaterials[num7], mesh, num7, idxInResultMats, meshChannelsCache, dictionary, out array5[num7], out array6[num7], out array7[num7], ref errorMsg, LOG_LEVEL))
						{
					...
					if (_003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i] != null)
					{
						list2.Add(mB_DynamicGameObject);
						mB_DynamicGameObject.name = string.Format("{0} {1}", _003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i].ToString(), _003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i].GetInstanceID());
						mB_DynamicGameObject.instanceID = _003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i].GetInstanceID();
				...
				else
				{
					if (LOG_LEVEL >= MB2_LogLevel.warn)
					{
						Debug.LogWarning("Object " + _003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i].name + " has already been added");
					}
					_003C_addToCombined_003Ec__AnonStorey._goToAdd[_003C_addToCombined_003Ec__AnonStorey2.i] = null;
				}
				_003C_addToCombined_003Ec__AnonStorey2.i++;
			}
			for (int num9 = 0; num9 < _003C_addToCombined_003Ec__AnonStorey._goToAdd.Length; num9++)
			{
				if (_003C_addToCombined_003Ec__AnonStorey._goToAdd[num9] != null && disableRendererInSource)
				{
					MB_Utility.DisableRendererInSource(_003C_addToCombined_003Ec__AnonStorey._goToAdd[num9]);
					if (LOG_LEVEL == MB2_LogLevel.trace)
					{
						Debug.Log("Disabling renderer on " + _003C_addToCombined_003Ec__AnonStorey._goToAdd[num9].name + " id=" + _003C_addToCombined_003Ec__AnonStorey._goToAdd[num9].GetInstanceID());
					}
				}
			}
			...
			if (LOG_LEVEL >= MB2_LogLevel.debug)
			{
				Debug.Log("Verts adding:" + num4 + " deleting:" + num2 + " submeshes:" + array8.Length + " bones:" + num11 + " blendShapes:" + num12);
			}
			for (int num13 = 0; num13 < array8.Length; num13++)
			{
				array8[num13] = submeshTris[num13].data.Length + array4[num13] - array2[num13];
				if (LOG_LEVEL >= MB2_LogLevel.debug)
				{
			...
			{
				array13[num14] = new SerializableIntArray(array8[num14]);
			}
			...
			for (int num19 = 0; num19 < mbDynamicObjectsInCombinedMesh.Count; num19++)
			{
				...
				if (!mB_DynamicGameObject2._beingDeleted)
				{
					...
					for (int num20 = 0; num20 < num; num20++)
					{
						...
						Array.Copy(data, num21, array13[num20].data, array14[num20], num22);
					}
			...
			{
				array12[num26 + num27] = item.bone;
				array11[num26 + num27] = item.bindPose;
				num27++;
			}
			for (int num28 = 0; num28 < list2.Count; num28++)
			{
				MB_DynamicGameObject mB_DynamicGameObject3 = list2[num28];
				GameObject gameObject2 = _003C_addToCombined_003Ec__AnonStorey._goToAdd[num28];
				int num29 = num16;
				int index = num17;
				...
				else
				{
					if (_doNorm)
					{
						array15.CopyTo(normals, num29);
					}
					if (_doTan)
					{
						array16.CopyTo(tangents, num29);
					}
