...
namespace DigitalOpus.MB.Core
{
	...
	public class MB3_TextureCombiner
	{
		...
		[CompilerGenerated]
		private sealed class _003C_CollectPropertyNames_003Ec__AnonStorey9
		{
			internal List<ShaderTextureProperty> texPropertyNames;
		}

		[CompilerGenerated]
		private sealed class _003C_CollectPropertyNames_003Ec__AnonStoreyA
		{
			internal int i;

			internal _003C_CollectPropertyNames_003Ec__AnonStorey9 _003C_003Ef__ref_00249;

			internal bool _003C_003Em__0(ShaderTextureProperty x)
			{
				return x.name.Equals(_003C_003Ef__ref_00249.texPropertyNames[i].name);
			}
		}
		...
		{
			_003C_CollectPropertyNames_003Ec__AnonStorey9 _003C_CollectPropertyNames_003Ec__AnonStorey = new _003C_CollectPropertyNames_003Ec__AnonStorey9();
			_003C_CollectPropertyNames_003Ec__AnonStorey.texPropertyNames = texPropertyNames;
			_003C_CollectPropertyNames_003Ec__AnonStoreyA _003C_CollectPropertyNames_003Ec__AnonStoreyA = new _003C_CollectPropertyNames_003Ec__AnonStoreyA();
			_003C_CollectPropertyNames_003Ec__AnonStoreyA._003C_003Ef__ref_00249 = _003C_CollectPropertyNames_003Ec__AnonStorey;
			_003C_CollectPropertyNames_003Ec__AnonStoreyA.i = 0;
			while (_003C_CollectPropertyNames_003Ec__AnonStoreyA.i < _003C_CollectPropertyNames_003Ec__AnonStorey.texPropertyNames.Count)
			{
				ShaderTextureProperty shaderTextureProperty = _customShaderPropNames.Find(_003C_CollectPropertyNames_003Ec__AnonStoreyA._003C_003Em__0);
				if (shaderTextureProperty != null)
				{
					_customShaderPropNames.Remove(shaderTextureProperty);
				}
				_003C_CollectPropertyNames_003Ec__AnonStoreyA.i++;
			}
			...
			for (int i = 0; i < shaderTexPropertyNames.Length; i++)
			{
				if (resultMaterial.HasProperty(shaderTexPropertyNames[i].name))
				{
					...
					if (!_003C_CollectPropertyNames_003Ec__AnonStorey.texPropertyNames.Contains(shaderTexPropertyNames[i]))
					{
						_003C_CollectPropertyNames_003Ec__AnonStorey.texPropertyNames.Add(shaderTexPropertyNames[i]);
					}
			...
			for (int j = 0; j < _customShaderPropNames.Count; j++)
			{
				if (resultMaterial.HasProperty(_customShaderPropNames[j].name))
				{
					...
					_003C_CollectPropertyNames_003Ec__AnonStorey.texPropertyNames.Add(_customShaderPropNames[j]);
		...
		private IEnumerator __Step1_CollectDistinctMatTexturesAndUsedObjects(ProgressUpdateDelegate progressInfo, CombineTexturesIntoAtlasesCoroutineResult result, List<GameObject> allObjsToMesh, List<Material> allowedMaterialsFilter, List<ShaderTextureProperty> texPropertyNames, MB2_EditorMethodsInterface textureEditorMethods, List<MB_TexSet> distinctMaterialTextures, List<GameObject> usedObjsToMesh)
		{
			...
			for (int i = 0; i < allObjsToMesh.Count; i++)
			{
				...
				{
					_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__Iterator4._003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB _003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB = new _003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__Iterator4._003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB();
					_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB._003C_003Ef__ref_00244 = this;
					if (progressInfo != null)
					{
					...
					_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs = new MB_TexSet(array, uvOffset, uvScale);
					MatAndTransformToMerged item = new MatAndTransformToMerged(material);
					_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs.matsAndGOs.mats.Add(item);
					MB_TexSet mB_TexSet = distinctMaterialTextures.Find(_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB._003C_003Em__0);
					if (mB_TexSet != null)
					{
						_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs = mB_TexSet;
					}
					else
					{
						distinctMaterialTextures.Add(_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs);
					}
					if (!_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs.matsAndGOs.mats.Contains(item))
					{
						_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs.matsAndGOs.mats.Add(item);
					}
					if (!_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs.matsAndGOs.gos.Contains(gameObject))
					{
						_003C__Step1_CollectDistinctMatTexturesAndUsedObjects_003Ec__AnonStoreyB.setOfTexs.matsAndGOs.gos.Add(gameObject);
			...
			else
			{
				...
				for (int propIdx = 0; propIdx < numAtlases; propIdx++)
				{
					...
					else
					{
						...
						GC.Collect();
						Color[][] atlasPixels = new Color[atlasSizeY2][];
						for (int k = 0; k < atlasPixels.Length; k++)
						{
							atlasPixels[k] = new Color[atlasSizeX2];
						}
						...
						atlas2 = new Texture2D(atlasSizeX2, atlasSizeY2, TextureFormat.ARGB32, true);
		...
		public IEnumerator CopyScaledAndTiledToAtlas(MeshBakerMaterialTexture source, MB_TexSet sourceMaterial, ShaderTextureProperty shaderPropertyName, DRect srcSamplingRect, int targX, int targY, int targW, int targH, bool _fixOutOfBoundsUVs, int maxSize, Color[][] atlasPixels, int atlasWidth, bool isNormalMap, ProgressUpdateDelegate progressInfo = null)
		{
			...
			for (int k = 0; k < w; k++)
			{
				...
				for (int l = 0; l < h; l++)
				{
					...
					atlasPixels[targY + l][targX + k] = t2.GetPixelBilinear(x, y);
				}
			}
			for (int m = 0; m < w; m++)
			{
