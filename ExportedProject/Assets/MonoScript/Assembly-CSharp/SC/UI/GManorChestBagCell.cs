...
namespace SC.UI
{
	public class GManorChestBagCell : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			m_novice_effect = base.transform.Find("m_something/m_novice_effect").gameObject;
			m_something = base.transform.Find("m_something").gameObject;
			txt_new = base.transform.Find("m_something/m_new/txt_new").gameObject;
