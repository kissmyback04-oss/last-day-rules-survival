...
namespace TMPro
{
	public static class TMP_MaterialManager
	{
		...
		[CompilerGenerated]
		private sealed class _003CGetBaseMaterial_003Ec__AnonStorey0
		{
			internal Material stencilMaterial;

			internal bool _003C_003Em__0(MaskingMaterial item)
			{
				return item.stencilMaterial == stencilMaterial;
			}
		}

		[CompilerGenerated]
		private sealed class _003CAddMaskingMaterial_003Ec__AnonStorey1
		{
			internal Material stencilMaterial;
		...
		[CompilerGenerated]
		private sealed class _003CRemoveStencilMaterial_003Ec__AnonStorey2
		{
			internal Material stencilMaterial;
		...
		[CompilerGenerated]
		private sealed class _003CReleaseBaseMaterial_003Ec__AnonStorey3
		{
			internal Material baseMaterial;

			internal bool _003C_003Em__0(MaskingMaterial item)
			{
				return item.baseMaterial == baseMaterial;
			}
		}
		...
		{
			_003CGetBaseMaterial_003Ec__AnonStorey0 _003CGetBaseMaterial_003Ec__AnonStorey = new _003CGetBaseMaterial_003Ec__AnonStorey0();
			_003CGetBaseMaterial_003Ec__AnonStorey.stencilMaterial = stencilMaterial;
			int num = m_materialList.FindIndex(_003CGetBaseMaterial_003Ec__AnonStorey._003C_003Em__0);
			if (num == -1)
			{
				return null;
			}
		...
		{
			_003CAddMaskingMaterial_003Ec__AnonStorey1 _003CAddMaskingMaterial_003Ec__AnonStorey = new _003CAddMaskingMaterial_003Ec__AnonStorey1();
			_003CAddMaskingMaterial_003Ec__AnonStorey.stencilMaterial = stencilMaterial;
			int num = m_materialList.FindIndex(_003CAddMaskingMaterial_003Ec__AnonStorey._003C_003Em__0);
			if (num == -1)
			{
				MaskingMaterial maskingMaterial = new MaskingMaterial();
				maskingMaterial.baseMaterial = baseMaterial;
				maskingMaterial.stencilMaterial = _003CAddMaskingMaterial_003Ec__AnonStorey.stencilMaterial;
				maskingMaterial.stencilID = stencilID;
				maskingMaterial.count = 1;
				m_materialList.Add(maskingMaterial);
			}
			...
			{
				_003CAddMaskingMaterial_003Ec__AnonStorey.stencilMaterial = m_materialList[num].stencilMaterial;
		...
		{
			_003CRemoveStencilMaterial_003Ec__AnonStorey2 _003CRemoveStencilMaterial_003Ec__AnonStorey = new _003CRemoveStencilMaterial_003Ec__AnonStorey2();
			_003CRemoveStencilMaterial_003Ec__AnonStorey.stencilMaterial = stencilMaterial;
			int num = m_materialList.FindIndex(_003CRemoveStencilMaterial_003Ec__AnonStorey._003C_003Em__0);
			if (num != -1)
			{
		...
		{
			_003CReleaseBaseMaterial_003Ec__AnonStorey3 _003CReleaseBaseMaterial_003Ec__AnonStorey = new _003CReleaseBaseMaterial_003Ec__AnonStorey3();
			_003CReleaseBaseMaterial_003Ec__AnonStorey.baseMaterial = baseMaterial;
			int num = m_materialList.FindIndex(_003CReleaseBaseMaterial_003Ec__AnonStorey._003C_003Em__0);
			if (num == -1)
			{
				Debug.Log("No Masking Material exists for " + _003CReleaseBaseMaterial_003Ec__AnonStorey.baseMaterial.name);
			}
