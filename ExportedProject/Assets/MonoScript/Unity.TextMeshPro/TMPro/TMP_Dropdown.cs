...
namespace TMPro
{
	...
	public class TMP_Dropdown : Selectable, IPointerClickHandler, ISubmitHandler, ICancelHandler, IEventSystemHandler
	{
		...
		[CompilerGenerated]
		private sealed class _003CShow_003Ec__AnonStorey1
		{
			internal DropdownItem item;

			internal TMP_Dropdown _0024this;

			internal void _003C_003Em__0(bool x)
			{
				_0024this.OnSelectItem(item.toggle);
			}
		}
		...
		public void Show()
		{
			...
			for (int i = 0; i < options.Count; i++)
			{
				_003CShow_003Ec__AnonStorey1 _003CShow_003Ec__AnonStorey = new _003CShow_003Ec__AnonStorey1();
				_003CShow_003Ec__AnonStorey._0024this = this;
				OptionData data = options[i];
				_003CShow_003Ec__AnonStorey.item = AddItem(data, value == i, componentInChildren, m_Items);
				if (!(_003CShow_003Ec__AnonStorey.item == null))
				{
					_003CShow_003Ec__AnonStorey.item.toggle.isOn = value == i;
					_003CShow_003Ec__AnonStorey.item.toggle.onValueChanged.AddListener(_003CShow_003Ec__AnonStorey._003C_003Em__0);
					if (_003CShow_003Ec__AnonStorey.item.toggle.isOn)
					{
						_003CShow_003Ec__AnonStorey.item.toggle.Select();
					}
					if (toggle != null)
					{
						Navigation navigation = toggle.navigation;
						Navigation navigation2 = _003CShow_003Ec__AnonStorey.item.toggle.navigation;
						navigation.mode = Navigation.Mode.Explicit;
						navigation2.mode = Navigation.Mode.Explicit;
						navigation.selectOnDown = _003CShow_003Ec__AnonStorey.item.toggle;
						navigation.selectOnRight = _003CShow_003Ec__AnonStorey.item.toggle;
						navigation2.selectOnLeft = toggle;
						navigation2.selectOnUp = toggle;
						toggle.navigation = navigation;
						_003CShow_003Ec__AnonStorey.item.toggle.navigation = navigation2;
					}
					toggle = _003CShow_003Ec__AnonStorey.item.toggle;
				}
			}
